...
(function () {
  ...
  const translations = {
    en: {
      ...
      'hero-title-3': '2027',
      'hero-subtitle': 'Physics League Across Numerous Countries for Kick-ass Students. The first edition of PLANCKS in Central America — where the ancient Maya civilisation meets the frontier of modern physics.',
      ...
      'register-info-1': 'Early 2026 — Registration opens',
      ...
      'committee-title': 'Trinational Organising Committee',
      ...
      'about-p3': 'Beyond competition, PLANCKS is a four-day cultural and scientific exchange: symposia, laboratory visits, excursions, and an awards ceremony that celebrates excellence in physics education on an international stage.',
      ...
      'honduras-p2': 'Home to Copán — one of the great Maya ceremonial centres and a UNESCO World Heritage Site — and to cloud forests, coral reefs, and colonial cities, Honduras offers an incomparable cultural backdrop for an international scientific gathering.',
      'honduras-fact-1-label': 'Edition Year',
      'honduras-fact-1-p': 'Dates TBD · Honduras',
      ...
      'honduras-fact-4-p': 'Science & Culture',
      'venue-eyebrow': 'Venue',
      'venue-title': '[Venue Name<br>To Be Confirmed]',
      'venue-desc': 'The venue details will be announced in early 2026. We are working with leading Honduran academic institutions to secure a world-class setting worthy of PLANCKS\'s international reputation.',
      'venue-location-label': 'Location',
      'venue-location-val': 'Honduras, Central America — city TBD',
      'venue-date-label': 'Date',
      'venue-date-val': '2027 — Exact dates to be announced',
      ...
      'venue-transport-val': 'Shuttle service included',
      'venue-capacity-label': 'Capacity',
      'venue-capacity-val': 'Full competition hall + seminar rooms + social spaces',
      ...
      'itinerary-notice': '📄 Updated January 2026',
      ...
      'faq-a7': 'Follow IAPS on social media or contact us directly via the email below. Registration will open in early 2026. All national IAPS committees will be notified as soon as dates and fees are confirmed.',
    ...
    es: {
      ...
      'hero-title-2': 'Honduras',
      'hero-title-3': '2027',
      'hero-subtitle': 'Physics League Across Numerous Countries for Kick-ass Students. La primera edición de PLANCKS en Centroamérica — donde la antigua civilización maya se encuentra con la frontera de la física moderna.',
      ...
      'register-info-1': 'Inicios 2026 — Apertura de inscripciones',
      ...
      'committee-title': 'Comité Organizador Trinacional',
      ...
      'about-p3': 'Más allá de la competencia, PLANCKS es un intercambio cultural y científico de cuatro días: simposios, visitas a laboratorios, excursiones y una ceremonia de premiación que celebra la excelencia en la educación física en el escenario internacional.',
      ...
      'honduras-p2': 'Hogar de Copán — uno de los grandes centros ceremoniales mayas y Patrimonio Mundial de la UNESCO — y de bosques nubosos, arrecifes de coral y ciudades coloniales, Honduras ofrece un telón de fondo cultural incomparable para una reunión científica internacional.',
      'honduras-fact-1-label': 'Edición',
      'honduras-fact-1-p': 'Fechas TBD · Honduras',
      ...
      'honduras-fact-4-p': 'Ciencia y Cultura',
      'venue-eyebrow': 'Sede',
      'venue-title': '[Nombre de la Sede<br>Por Confirmar]',
      'venue-desc': 'Los detalles de la sede se anunciarán a principios de 2026. Estamos trabajando con instituciones académicas hondureñas líderes para asegurar un entorno de clase mundial digno de la reputación internacional de PLANCKS.',
      'venue-location-label': 'Ubicación',
      'venue-location-val': 'Honduras, Centroamérica — ciudad TBD',
      'venue-date-label': 'Fecha',
      'venue-date-val': '2027 — Fechas exactas por anunciar',
      ...
      'venue-transport-val': 'Servicio de transporte incluido',
      'venue-capacity-label': 'Capacidad',
      'venue-capacity-val': 'Salón de competencia + salas de seminarios + espacios sociales',
      ...
      'itinerary-notice': '📄 Actualizado Enero 2026',
      ...
      'faq-a7': 'Sigue a IAPS en redes sociales o contáctanos directamente a través del correo electrónico abajo. La inscripción se abrirá a principios de 2026. Todos los comités nacionales de IAPS serán notificados tan pronto como se confirmen las fechas y tarifas.',
